...
function obj:start()
    ...
    hs.hotkey.bind({"cmd"}, 'f9', function() hs.execute('open -n -a "Google Chrome" --args --profile-directory="Default"') end)
    hs.hotkey.bind({"cmd", "shift"}, 'f9', function() hs.application.launchOrFocus('google chrome') end)
