...
function obj:start()
    ...
    -- hs.hotkey.bind({"cmd"}, 'f2', function() hs.application.launchOrFocus('telegram') end)
    hs.hotkey.bind({"cmd"}, 'f3', function() hs.application.launchOrFocus('claude') end)
    ...
    hs.hotkey.bind({"cmd"}, 'f6', function() hs.application.launchOrFocus('fantastical') end)
    ...
    hs.hotkey.bind({"cmd"}, 'f12', function() hs.application.launchOrFocus('obsidian') end)
