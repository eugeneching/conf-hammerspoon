...
function obj:start()
    ...
    hs.hotkey.bind({"cmd"}, 'f2', function() hs.application.launchOrFocus('fantastical') end)
    hs.hotkey.bind({"cmd"}, 'f3', function() hs.application.launchOrFocus('whatsapp') end)
    ...
    hs.hotkey.bind({"cmd"}, 'f6', function() hs.application.launchOrFocus('telegram') end)
